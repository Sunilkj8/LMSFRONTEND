  ...
  return (
    <div className="mt-[10vh] h-auto items-center  flex justify-center flex-col gap-10 bg-[] py-10     ">
      {userBorrowedBooks.map((elem) => {
        return (
          <div className="  flex w-[70vw] h-[20%] items-center justify-between p-[5em] border-[1px] border-black  rounded-lg hover:scale-[1.05] cursor-pointer duration-300 bg-white ">
            <div className="h[50%] p-7  w-[17vw]  flex justify-center items-center">
              <img className="w-[95%]" src={elem.book_image} alt="" />
            </div>
            <div className="flex justify-center flex-col gap-10 ">
              ...
              <div className="  flex items-center justify-center">
                <p className="w-[50%] text-center ">{elem.book_description}</p>
              </div>
