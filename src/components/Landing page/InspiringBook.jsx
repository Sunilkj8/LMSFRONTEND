...
const InspiringBook = () => {
  return (
    <div className=" blockElem h-[130vh] w-[99vw] flex justify-center items-center">
      <div className="w-full h-[100vh] max-w-[94vw] flex items-center p-10  shadow-2xl rounded-3xl bg-black text-white flex-col gap-10 ">
        ...
        <div className="h-full flex gap-10 justify-center items-center">
          <div className="flex flex-col   w-1/2 border-r h-full items-center justify-center p-10">
